...
export declare const models: {
  public: {
    ...
    SecureFile: Models.public_SecureFile;
  };
};
        ...
        readonly entries: {
          readonly table: {
              ...
              indexes: readonly [
                {
                  ...
                  readonly prefix: 'secureFile_senderId_recipientId_createdAt_idx';
                  readonly columns: readonly ['senderId', 'recipientId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'secureFile_recipientId_senderId_createdAt_idx_fd885bcc';
                  readonly prefix: 'secureFile_recipientId_senderId_createdAt_idx';
                  readonly columns: readonly ['recipientId', 'senderId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'secureFile_senderId_idx_4689c490';
                  readonly prefix: 'secureFile_senderId_idx';
                  readonly columns: readonly ['senderId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'secureFile_recipientId_idx_c9527cf8';
                  readonly prefix: 'secureFile_recipientId_idx';
            ...
            readonly securityEvent: {
              ...
              indexes: readonly [
                {
                  readonly name: 'securityEvent_eventType_occurredAt_idx_d85e1cc5';
                  readonly prefix: 'securityEvent_eventType_occurredAt_idx';
                  readonly columns: readonly ['eventType', 'occurredAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'securityEvent_actorId_occurredAt_idx_38439793';
                  readonly prefix: 'securityEvent_actorId_occurredAt_idx';
                  readonly columns: readonly ['actorId', 'occurredAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'securityEvent_referenceId_eventType_occurredAt_idx_ae488262';
                  readonly prefix: 'securityEvent_referenceId_eventType_occurredAt_idx';
                  readonly columns: readonly ['referenceId', 'eventType', 'occurredAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'securityEvent_actorId_idx_a58f6b4b';
                  readonly prefix: 'securityEvent_actorId_idx';
